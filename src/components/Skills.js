  ...
  return (
    <>
      ...
      >
        ...
        <Skill name="Typescript" x="-12vw" y="-4vw" />
        <Skill name="CSS" x="-5vw" y="-10vw" />
        <Skill name="Javascript" x="14vw" y="-2vw" />
        <Skill name="NextJS" x="20vw" y="6vw" />
        <Skill name="ReactJS" x="0vw" y="12vw" />
        <Skill name="Bootstrap" x="7vw" y="-9vw" />
        <Skill name="Tailwind CSS" x="20vw" y="-8vw" />
        <Skill name="Framer-motion" x="20vw" y="-16vw" />
        <Skill name="Github" x="-35vw" y="-5vw" />
        <Skill name="Node" x="-25vw" y="-5vw" />
        <Skill name="Web Design" x="32vw" y="-5vw" />
        <Skill name="Styled-Components" x="25vw" y="12vw" />
